---
description: "How to Use Advanced Features of Igniter.js(Like jobs, pub/sub and more)"
targets: ["*"]
cursor: # cursor specific rules
  alwaysApply: true
  description: "How to Use Advanced Features of Igniter.js(Like jobs, pub/sub and more)"
---
# How to Use Advanced Features of Igniter.js(Like jobs, pub/sub and more)
  ...
  actions: {
    ...
    create: igniter.mutation({
      ...
      handler: async ({ request, context, response }) => {
        ...
        return response.revalidate(['posts.list']).created(newPost);
      }
    })
  }
});
