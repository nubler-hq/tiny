---
description: "Browser Tools: Comprehensive Training & Best Practices"
targets: ["*"]
...
This rule provides a comprehensive and mandatory training guide for effectively utilizing browser automation tools for research, debugging, and autonomous validation. It emphasizes integrating browser capabilities with other MCP tools for a holistic development workflow.

## 1. Core Principles of Browser Tool Usage

### 1.1 Strategic Intent
- **Dynamic Research & Learning**: PRIMARY PURPOSE - Access real-time, external information, documentation, community insights, and technology updates from the web.
- **Continuous Education**: Stay current with technology trends, best practices, frameworks, and industry developments.
- **Market Analysis**: Conduct competitor research, analyze market trends, and identify emerging technologies.
- **Community Engagement**: Access forums, Stack Overflow, Reddit, GitHub discussions for real-world insights and solutions.
...
- **Free Exploration**: Browser tools must be used FREELY for any task requested by the user, including research, learning, market analysis, competitor analysis, and general web exploration.
- **Continuous Learning**: Lia must actively use browser tools to stay current with technology trends, best practices, and community knowledge.
- **Task Execution**: Browser tools are available for executing ANY web-based task the user requests, not just testing.
...
The following browser automation tools are available for browser interaction:
...
6.  `store_memory({ type: "code_pattern", title: "Login Flow Validation", content: "...", tags: ["e2e", "authentication", "browser-tools"] })`
...
-   **ALL implementations must be validated using browser automation tools.**
...
-   **Use browser FREELY for ANY task requested by the user, not just testing.**
-   **Browser tools are the PRIMARY means for research, learning, and market analysis.**
-   **Access latest documentation, forums, community knowledge, and technology updates.**
-   **Execute interactive web tasks, data extraction, and any web-based functionality.**
-   **Browser usage is MANDATORY for continuous learning and staying current with technology trends.**
...
## 8. Browser Freedom & Task Execution Protocol

### 8.1 Absolute Freedom of Browser Usage
**MANDATORY FREEDOM REQUIREMENT:**
- **Browser tools MUST be used FREELY** for ANY task requested by the user, without restrictions or limitations.
- **No prior approval needed** for browser usage - Lia can use browser tools whenever beneficial for any purpose.
- **Research and learning activities** should be the PRIMARY use of browser tools, not just testing.
- **Market analysis and competitor research** must be conducted proactively using browser tools.
- **Technology updates and best practices** should be continuously explored via browser tools.
- **Community knowledge and forums** must be actively accessed for current insights.

### 8.2 Research & Learning Protocol
**MANDATORY RESEARCH ACTIVITIES:**
- **Continuous Technology Monitoring**: Regularly explore technology trends, new frameworks, and industry updates.
- **Community Engagement**: Access forums, Stack Overflow, Reddit, GitHub discussions for real-world insights.
- **Documentation Updates**: Always check latest official documentation and release notes.
- **Competitor Analysis**: Research competitor solutions, features, and user experiences.
- **Best Practices Evolution**: Stay current with evolving development best practices and patterns.
- **Market Research**: Analyze market trends, user needs, and emerging technologies.

### 8.3 Task Execution Freedom
**ANY WEB-BASED TASK EXECUTION:**
- **User-Requested Tasks**: Execute ANY web-based task the user requests via browser tools.
- **Autonomous Initiative**: Take initiative to use browser tools for research and learning opportunities.
- **Interactive Web Tasks**: Handle forms, searches, data extraction, and any interactive web functionality.
- **Multi-Tab Research**: Use `browser_tabs` for parallel research activities.
- **Screenshot Documentation**: Capture visual evidence and documentation using `browser_take_screenshot`.
- **Network Analysis**: Monitor and analyze web requests using `browser_network_requests`.

### 8.4 Knowledge Synthesis Protocol
**MANDATORY KNOWLEDGE INTEGRATION:**
- **External Knowledge Integration**: Synthesize web research with internal knowledge base.
- **Pattern Discovery**: Identify new patterns and best practices from web exploration.
- **Technology Updates**: Update internal knowledge based on latest web findings.
- **Competitive Intelligence**: Incorporate competitor analysis insights into development decisions.
- **Community Wisdom**: Apply community solutions and discussions to local problems.

### 8.5 Proactive Browser Usage
**MANDATORY PROACTIVE ACTIVITIES:**
- **Daily Technology Scan**: Start each session with technology updates and industry news.
- **Research-Driven Development**: Use browser research to inform and enhance development decisions.
- **Continuous Learning**: Dedicate time for web exploration and learning activities.
- **Market Awareness**: Maintain awareness of market trends and user needs.
- **Best Practices Updates**: Regularly update understanding of current best practices.
